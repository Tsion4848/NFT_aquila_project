  ...
  return (
    <div>
        ...
        <div className='contact'>
            <div className='left'>
                <Photo id='photoIcon' />
                <input id='chooseFile' type='file' name='file' onChange={handleImage}/>
            ...
            <div className='right'>
                <form id='contact-form' method='POST'>
                    ...
                    <input name='duration' placeholder='Enter auction duration' type='date' onChange={e=>setDate(e.target.value)}/>
