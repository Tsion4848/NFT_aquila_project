...
import tigro from '../assets/tigro.jpg'
...
const Tigro = () => {
  ...
  return (
    <div className='alien'>
      <div className='left' style={{ backgroundImage:`url(${tigro})` }}></div>
      <div className='right'>
        <h1>Tigro</h1>
        ...
        <div>&nbsp;</div>
        <p>The mother remains the most beautiful thing in this world, no matter how different the nature of the living being.</p>
        <h3>by Rikunow</h3>
        {/* <div>&nbsp;</div> */}
