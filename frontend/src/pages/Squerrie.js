...
import squerrie from '../assets/squerrie.jpg'
...
const Squerrie = () => {
  ...
  return (
    <div className='alien'>
      <div className='left' style={{ backgroundImage:`url(${squerrie})` }}></div>
      <div className='right'>
        <h1>Squerrie</h1>
        ...
        <div>&nbsp;</div>
        <p>A ground squirrel smelling a flower</p>
        <h3>by Dick van Duijin</h3>
        {/* <div>&nbsp;</div> */}
